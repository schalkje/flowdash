...
Files here are kept for reference only. They are **not** part of the curated demo navigation. Either:

- Fold their content into `01_simple-tests/` or `02_extended-tests/`, or
- Delete the file once the comparison it shows is covered by the curated demos.
