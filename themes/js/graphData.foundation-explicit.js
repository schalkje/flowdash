...
export const demoData = {
  metadata: {
    ...
    description:
      'Lane with multiple foundation nodes, one per state, each collapsed with explicit role children',
