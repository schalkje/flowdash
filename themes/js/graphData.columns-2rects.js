...
export const demoData = {
  metadata: {
    ...
    description:
      'Columns with multiple child columns, one per state, each collapsed and containing two rectangles',
