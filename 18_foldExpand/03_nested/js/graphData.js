                    ...
                    children: [
                        {
                            ...
                            collapsed: false,
                            children: [
                                { id: "rect-a1", label: "A · 1", type: "rect", code: "A1", state: "Ready", parentId: "wing-a-cols" },
                                { id: "rect-a2", label: "A · 2", type: "rect", code: "A2", state: "Ready", parentId: "wing-a-cols" }
                            ],
                            parentId: "wing-a"
                        }
                    ],
                    ...
                    children: [
                        {
                            ...
                            collapsed: false,
                            children: [
                                { id: "rect-b1", label: "B · 1", type: "rect", code: "B1", state: "Ready", parentId: "wing-b-cols" },
                                { id: "rect-b2", label: "B · 2", type: "rect", code: "B2", state: "Ready", parentId: "wing-b-cols" }
                            ],
                            parentId: "wing-b"
                        }
                    ],
