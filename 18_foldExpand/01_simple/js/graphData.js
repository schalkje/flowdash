    ...
    nodes: [
        {
            ...
            collapsed: false,
            children: [
                { id: "rect1", label: "Step 1", type: "rect", code: "R1", state: "Ready", parentId: "lane1" },
                { id: "rect2", label: "Step 2", type: "rect", code: "R2", state: "Ready", parentId: "lane1" },
                { id: "rect3", label: "Step 3", type: "rect", code: "R3", state: "Ready", parentId: "lane1" }
            ],
            parentId: null
        }
    ],
