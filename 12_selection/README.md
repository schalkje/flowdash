...
- **Double click** computes a *Selection Neighborhood* (a BFS over edges with depth limits from `settings.selector.incomming` and `settings.selector.outgoing`) and zooms to its bounding box.
